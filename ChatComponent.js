...
import { db } from './firebase/config';  // Import db từ config.js
...
const ChatComponent = () => {
    ...
    const [friendName, setFriendName] = useState('friend1');
        ...
        const fetchMessages = async () => {
            ...
            if (!querySnapshot.empty || !querySnapshot2.empty) {
                ...
                querySnapshot.docs.forEach((doc) => {
                    allMessages.push(...doc.data().conversation);
                });
                ...
                // Sắp xếp các tin nhắn theo timestamp
